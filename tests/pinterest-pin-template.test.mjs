...
test("every article carries exactly two pins, one of each creative type", () => {
  assert.equal(registry.pins.length, 16);
...
test("every local Pin asset exists at the registry path with exact dimensions", async () => {
  for (const pin of registry.pins) {
